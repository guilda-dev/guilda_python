...
@overload
def array(object: ArrayProtocol) -> ArrayProtocol: ...


def copy(object: ArrayProtocol) -> ArrayProtocol: ...


def asnp(object: ArrayProtocol) -> NDArray: ...


def zeros(shape: ShapeLike, *args, **kwargs) -> ArrayProtocol: ...


def ones(shape: ShapeLike, *args, **kwargs) -> ArrayProtocol: ...


def identity(shape: int, *args, **kwargs) -> ArrayProtocol: ...
...
class ArrayProtocol:
    ...
    # @overload
    def __getitem__(
        self, index: Union[int | slice, Tuple[(int | slice), ...]]) -> Any: ...

    def __setitem__(
        self, index: Union[int | slice, Tuple[(int | slice), ...]], value: Any) -> None: ...
    ...
    @overload
    def __matmul__(self, other: ArrayLike) -> ArrayProtocol: ...
